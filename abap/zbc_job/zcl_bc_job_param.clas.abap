"! <p class="shorttext synchronized">ZTJOB_RUN-PARAM 직렬화</p>
"!
...
CLASS zcl_bc_job_param DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS deserialize
      IMPORTING
        iv_json         TYPE string
      RETURNING
        VALUE(rs_param) TYPE zif_bc_job=>ty_param.

ENDCLASS.


CLASS zcl_bc_job_param IMPLEMENTATION.
