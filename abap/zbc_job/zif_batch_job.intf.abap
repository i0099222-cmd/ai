...
INTERFACE zif_batch_job
  ...
  "! 잡 파라미터 값 한 쌍. ZTBATCH_SCHED-PARAM 의 JSON 배열 원소.
  "! name 은 실행 클래스가 GET_PARAMETERS 에서 정의한 SELNAME 과 일치해야 한다.
  TYPES:
    BEGIN OF ty_param_value,
      name  TYPE c LENGTH 8,
      value TYPE string,
    END OF ty_param_value,
    tt_param_value TYPE STANDARD TABLE OF ty_param_value WITH EMPTY KEY.
