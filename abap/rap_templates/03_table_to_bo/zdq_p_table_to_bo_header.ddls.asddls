...
@EndUserText.label: 'Case3: 구매주문 헤더 (Projection)'
@Metadata.allowExtensions: true
@Search.searchable: true
@UI.headerInfo: { typeName: '구매주문', typeNamePlural: '구매주문', title: { value: 'OrderId' } }
@ObjectModel.semanticKey: [ 'OrderId' ]
define root view entity ZDQ_P_TABLE_TO_BO_HEADER
  provider contract transactional_query
  as projection on ZDQ_R_TABLE_TO_BO_HEADER
{
  ...
  key OrderId,
      ...
      _Item : redirected to composition child ZDQ_P_TABLE_TO_BO_ITEM
}
